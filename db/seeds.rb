...
Todo.create(task: "Water the plants", user_id: 2, assignee: "fix this", upvote: 3, completed: false, category: "house", priority: "medium")
Todo.create(task: "Do dishes", user_id: 2, assignee: "fix this", upvote: 2, completed: true, category: "house", priority: "low")
